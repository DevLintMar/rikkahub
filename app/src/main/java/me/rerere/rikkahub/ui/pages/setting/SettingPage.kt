            ...
            item("modelServices") {
                CardGroup(
                    ...
                    item(
                        ...
                        supportingContent = { Text(stringResource(R.string.setting_system_tools_desc)) },
                        headlineContent = { Text(stringResource(R.string.setting_system_tools)) },
                    )
                }
            }
            ...
            item("dataSettings") {
                ...
                CardGroup(
                    ...
                    item(
                        ...
                        leadingContent = { Icon(ForkIcons.Database02, null) },
